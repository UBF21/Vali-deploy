...
public class CompositionRootTests
{
    private static IStepExecutor[] BuildExecutors() =>
        CompositionRoot.BuildExecutors(new Mock<IProcessRunner>().Object, new Mock<ISshClientFactory>().Object, new Mock<ISecretResolver>().Object, new Mock<IInteractiveProcessLauncher>().Object);
